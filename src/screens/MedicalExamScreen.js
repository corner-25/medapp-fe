          ...
          <View style={styles.patientInfoContainer}>
            ...
            <View style={styles.patientInfoContent}>
              ...
              {currentPatient.healthInsuranceId && (
                <Text style={styles.patientDetails}>BHYT: {maskSensitiveData(currentPatient.healthInsuranceId, 3)}</Text>
              )}
              {currentPatient.nationalId && (
                <Text style={styles.patientDetails}>CMND/CCCD: {maskSensitiveData(currentPatient.nationalId, 3)}</Text>
              )}
            </View>
          </View>
        )}

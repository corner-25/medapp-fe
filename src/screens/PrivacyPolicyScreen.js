      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            MedApp - Ứng dụng Y tế Thông minh cam kết bảo vệ quyền riêng tư và thông tin cá nhân của bạn.
            Chính sách này mô tả cách chúng tôi thu thập, sử dụng, lưu trữ và bảo vệ
            thông tin của bạn khi sử dụng ứng dụng đặt khám bệnh, quản lý hồ sơ y tế và dịch vụ cấp cứu trực tuyến.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            ...
            • Dữ liệu phiên làm việc và thống kê sử dụng
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            • Cung cấp dịch vụ đặt khám bệnh tại các cơ sở y tế{'\n'}
            • Quản lý hồ sơ sức khỏe điện tử cá nhân{'\n'}
            • Quản lý thông tin người thân và người liên hệ khẩn cấp{'\n'}
            • Liên hệ và hỗ trợ khách hàng qua nhiều kênh{'\n'}
            • Gửi thông báo về lịch hẹn, kết quả xét nghiệm và báo cáo{'\n'}
            • Cung cấp dịch vụ tra cứu bệnh viện và cơ sở y tế{'\n'}
            • Xử lý thanh toán và quản lý giỏ hàng dịch vụ{'\n'}
            • Cải thiện chất lượng dịch vụ và trải nghiệm người dùng{'\n'}
            • Tuân thủ các quy định pháp luật về y tế và bảo mật dữ liệu{'\n'}
            • Phân tích và thống kê (dữ liệu đã được ẩn danh hóa)
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            • Bác sĩ và nhân viên y tế của các cơ sở liên kết để cung cấp dịch vụ khám chữa bệnh{'\n'}
            • Bệnh viện và phòng khám hợp tác (bao gồm Bệnh viện Vạn An){'\n'}
            • Công ty bảo hiểm y tế (chỉ khi được sự đồng ý rõ ràng){'\n'}
            • Cơ quan pháp luật và y tế (khi có yêu cầu hợp pháp){'\n'}
            • Đối tác kỹ thuật để vận hành và bảo trì hệ thống{'\n'}
            • Dịch vụ thanh toán điện tử (cho việc xử lý giao dịch)
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            • Mã hóa dữ liệu bằng tiêu chuẩn SSL/TLS 256-bit{'\n'}
            • Lưu trữ trên server được bảo mật với chứng chỉ quốc tế{'\n'}
            • Kiểm soát truy cập hai lớp (2FA) cho tài khoản nhạy cảm{'\n'}
            • Sao lưu dữ liệu tự động hàng ngày{'\n'}
            • Giám sát bảo mật và phát hiện xâm nhập 24/7{'\n'}
            • Tuân thủ tiêu chuẩn ISO 27001 và HIPAA{'\n'}
            • Ẩn danh hóa dữ liệu cho các mục đích phân tích{'\n'}
            • Phân quyền truy cập theo vai trò và chức năng
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.paragraph}>
            Nếu bạn có câu hỏi về chính sách này hoặc muốn thực hiện quyền riêng tư của mình,
          ...
          <View style={styles.contactInfo}>
            <View style={styles.contactItem}>
              ...
              <TouchableOpacity onPress={() => handleContactPress('email', 'privacy@medapp.vn')}>
                <Text style={styles.contactText}>privacy@medapp.vn</Text>
              </TouchableOpacity>
            </View>

            <View style={styles.contactItem}>
              <Icon name="call-outline" size={16} color="#4285F4" />
              <TouchableOpacity onPress={() => handleContactPress('phone', '0283-8386-688')}>
                <Text style={styles.contactText}>028 3838 6688</Text>
              </TouchableOpacity>
            </View>
            ...
            <View style={styles.contactItem}>
              ...
              <Text style={styles.contactAddress}>
                Bệnh viện Vạn An, 60 Cao Thắng, P.12, Quận 10, TP.HCM
              </Text>
            </View>

            <View style={styles.contactItem}>
              <Icon name="time-outline" size={16} color="#4285F4" />
              <Text style={styles.contactAddress}>
                Thời gian hỗ trợ: 24/7 cho các vấn đề về quyền riêng tư
              </Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            © 2024 MedApp - Ứng dụng Y tế Thông minh. Tất cả quyền được bảo lưu.
          </Text>
          <Text style={styles.footerSubText}>
            Phiên bản chính sách: 3.0 | Được phát triển tại Việt Nam
          </Text>
        </View>
